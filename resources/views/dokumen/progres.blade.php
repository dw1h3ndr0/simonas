...
<!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Progres Pengumpulan Dokumen</h1>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Progres Pengumpulan Dokumen Petugas</h6>                 
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="ProgresDokumenChart"></canvas>
                  </div>
                </div>
              </div>
            </div>    
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Realisasi Pengumpulan Dokumen Petugas</h6>                 
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="RealisasiDokumenChart"></canvas>
                  </div>
                </div>
              </div>
            </div>    
 ...
 @push('scripts')
  ...
  <script>
    ...
    var cDataDokumen = JSON.parse(`<?php echo $data_dokumen; ?>`);
    
    // Bar Chart Progres Dokumen
    var ctx = document.getElementById("ProgresDokumenChart");
    var myLineChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: cDataDokumen.label,
        datasets: [
        {
          label: "Selesai",
          data: cDataDokumen.selesai,
    ...
    // Bar Chart Realisasi Dokumen
    var ctx = document.getElementById("RealisasiDokumenChart");
    var myLineChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: cDataDokumen.label,
