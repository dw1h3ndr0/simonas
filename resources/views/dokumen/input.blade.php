...
@section('content')
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
	    <h1 class="h3 mb-0 text-gray-800">Input Pemasukan Dokumen</h1>
	    <div>
	    	<a href="#" data-toggle="modal" data-target="#importDokumen" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-file-import fa-lg text-white-50"></i> &nbsp; Import File </a>
	    </div>
    </div>
    ...
    <div class="container-fluid">
    	<div class="card shadow mb-4">
    		<div class="card-header py-3">    			
		      	<h6 class="m-0 font-weight-bold  card-title">
		      		<a href="{{ asset(route('dokumen', [], false)) }}"><i class="fas fa-chevron-left"></i></a>
		      		Input Pemasukan Dokumen
		  		</h6>
		    </div>    	

	    	<form action="{{ asset(route('dokumen.update', ['page'=> 'input'], false)) }}" method="POST">
	    	@csrf
   	...
   	<div class="modal fade" id="importDokumen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form method="post" action="{{ asset(route('dokumen.import_excel', [], false)) }}" enctype="multipart/form-data">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<a href="{{ URL::to( '/assets/template/template_dokumen.xls')  }}" target="_blank">download template</a>
						</div>
	...
	base_url="{{asset('')}}";	
		...
		$(document).ready(function() {			
    		...
    		$('select[name="nus"]').on('change', function() {
    		 	...
    		 	var url = base_url+'dokumen/'+kegiatan+'/'+nks+'/'+nus+'/input/edit';
