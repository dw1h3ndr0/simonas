...
<!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Progres Pencacahan</h1>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Progres Pencacahan Petugas</h6>                 
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="ProgresPencacahanChart"></canvas>
                  </div>
                </div>
              </div>
            </div>    
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Realisasi Pencacahan Petugas</h6>                 
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="RealisasiPencacahanChart"></canvas>
                  </div>
                </div>
              </div>
            </div>    
 ...
 @push('scripts')
  ...
  <script>
    ...
    var cDataPencacahan = JSON.parse(`<?php echo $data_pencacahan; ?>`);
    
    // Bar Chart Progres Pencacahan
    var ctx = document.getElementById("ProgresPencacahanChart");
    var myLineChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: cDataPencacahan.label,
        datasets: [
        {
          label: "Selesai",
          data: cDataPencacahan.selesai,
    ...
    // Bar Chart Realisasi Pencacahan
    var ctx = document.getElementById("RealisasiPencacahanChart");
    var myLineChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: cDataPencacahan.label,
        ...
        {
          label: "Realisasi (%)",
          data: cDataPencacahan.realisasi,
          backgroundColor: '#1cc88a',
          hoverBackgroundColor: '#17a673',
          hoverBorderColor: "rgba(234, 236, 244, 1)",
        }
